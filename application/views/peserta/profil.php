            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <h3 class="my-4 font-weight-bold text-dark">Profil Peserta</h3>
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body text-justify">
                                            <a href="<?= base_url() . 'peserta/edit_profil' ?>" class="mb-3 btn btn-info btn-block">
                                            ...
                                            <a href="<?= base_url('peserta') ?>" class="mb-3 btn btn-secondary  btn-block">
                                                <span class="icon text-white-50">
