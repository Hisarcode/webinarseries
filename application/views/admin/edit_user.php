<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <form class="user" method="POST" action="<?= base_url('admin/edit_user'); ?>">
                ...
                <div class="form-group">
                    <div class="input-group">
                        <input type="text" class="form-control form-control-user" name="tanggallahir" id="tanggallahir" placeholder="Tanggal" autocomplete="off" value="<?= $user['tanggallahir']; ?>">
                    </div>
