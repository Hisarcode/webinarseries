                        ...
                        <form class="user" method="POST" action="<?= base_url('admin/tambah_user'); ?>">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select class="custom-select" id="role_id" name="role_id" value="<?= set_value('role_id'); ?>">
                                    <option value='' selected>Masukan Kategori User</option>
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user" id="nik" name="nik" maxlength="16" placeholder="Masukkan Nomor Induk Kependudukan" value="<?= set_value('nik'); ?>">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-user" name="tanggallahir" id="tanggallahir" placeholder="Tanggal" autocomplete="off" value="<?= set_value('tanggallahir'); ?>">
                                </div>
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user" id="nomor_telepon" name="nomor_telepon" placeholder="Masukkan Nomor Telepon" value="<?= set_value('nomor_telepon'); ?>">
                            ...
                            <a href="<?= base_url('admin/manajemenuser') ?>" class="btn btn-secondary btn-user">Batal</a>
