                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Edit Data Profil Panitia</h6>
                        </div>
                        <div class="card-body">
                            <form action="" method="POST" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="email">Email : </label>
                                    <input type="text" class="form-control mb-2" value="<?= $user['email'] ?>" id="email" name="email" readonly>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control mb-2" value="<?= $user['nama'] ?>" id="nama" name="nama">
                                    <div class="invalid-feedback">
                                ...
                                <img src="<?= base_url('assets/img/profile/') . $user['image'];  ?>" class="mb-2 img-fluid col-lg-6" style="margin-left:-10px" height="auto">
                                <br>
                                <a href="<?= base_url('panitia/profil') ?>" class="btn btn-secondary btn-user">Batal</a>
